function F=LifeCycleModel8_Tax_ReturnFn(h,aprime,a,z,w,sigma,psi,eta,agej,Jr,pension,r,kappa_j,tau,warmglow1,warmglow2,warmglow3,beta,sj)

F=-Inf;
if agej<Jr % If working age
    c=(1-tau)*w*kappa_j*z*h+(1+r)*a-aprime; % Add z here
else % Retirement
